...
[`@aws-sdk/client-workspaces-web`](https://www.npmjs.com/package/@aws-sdk/client-workspaces-web/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces-web@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DcNX9BygfPjVciPNOWjQUO84mNF2dhiZynqM15ttLF5GhWz5t818QDb8wSMjRkcu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workspaces-web": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces-web@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces-web@3.787.0/index.min.mjs": "sha384-DcNX9BygfPjVciPNOWjQUO84mNF2dhiZynqM15ttLF5GhWz5t818QDb8wSMjRkcu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workspaces-web/blob/refs/tags/3.787.0/LICENSE
```
