...
[`@aws-sdk/client-workspaces-web`](https://www.npmjs.com/package/@aws-sdk/client-workspaces-web/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces-web@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9cUnyKq3CyRucQEZlTF1+WhTrACOsmeFZgmugmvlu7739UGsp7c8gUaiE7nRF0v0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workspaces-web": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces-web@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces-web@3.798.0/index.min.mjs": "sha384-9cUnyKq3CyRucQEZlTF1+WhTrACOsmeFZgmugmvlu7739UGsp7c8gUaiE7nRF0v0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workspaces-web/blob/refs/tags/3.798.0/LICENSE
```
