...
[`@aws-sdk/client-workspaces-web`](https://www.npmjs.com/package/@aws-sdk/client-workspaces-web/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces-web@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hG49JHUU30P1sVS2vwdqy2UgERL+rbcUUOZSiNxr32w1mtGPNTuLipyLU8we0geo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workspaces-web": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces-web@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces-web@3.906.0/index.min.mjs": "sha384-hG49JHUU30P1sVS2vwdqy2UgERL+rbcUUOZSiNxr32w1mtGPNTuLipyLU8we0geo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workspaces-web/blob/refs/tags/3.906.0/LICENSE
```
